...
Function to estimate the 7th root of the input x
...
"""
    function InverseHydrostaticEquationOfState(ρ₀, P, invCb)

Calculates the inverse hydrostatic equation of state
...
```
"""
@inline InverseHydrostaticEquationOfState(ρ₀, P, invCb) = ρ₀ * ( Estimate7thRoot( 1 + (P * invCb)))
